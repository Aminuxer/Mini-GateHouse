...
print '<form method="GET"><input type="text" size="3" value="'.$num.'" name="num" title="от '.$min_num.' до '.$max_num.'">Случайных паролей по <input type="text" size="3" value="'.$length.'" name="length" title="от '.$min_lenght.' до '.$max_lenght.'"> <input type="submit" value="символов длиной ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;['.date("Y-m-d H:i:s").']
<Br><INPUT type="text" name="alph" value="'.$alph.'" size="90"></form>
<Br><Br><table>';
